...
Tenant has.edu.vn chặn Device Code flow (AADSTS7000218) → dùng Interactive flow
(authorization_code + PKCE qua browser), cùng cơ chế với Graph Explorer.
"""
...
def main():
    ...
    print("Hoàn tất đăng nhập trên browser, script sẽ tự tiếp tục.\n")
    ...
    print(f"Chạy lại trước: {expire_date}")
